...
class PlayerComparisonLogic:
    ...
    def extract_player_data(player_row):
        ...
        pv_val = PlayerComparisonLogic.clean_numeric_value(player_row.get('Pv_weighted', 0))
        gf_val = PlayerComparisonLogic.clean_numeric_value(player_row.get('Gf_weighted', 0))
        ass_val = PlayerComparisonLogic.clean_numeric_value(player_row.get('Ass_weighted', 0))
        gs_val = PlayerComparisonLogic.clean_numeric_value(player_row.get('Gs_weighted', 0))
        rp_val = PlayerComparisonLogic.clean_numeric_value(player_row.get('Rp_weighted', 0))
