...
from src.data.team_stats import CLASSIFICA_REALE_2025_26
...
class PriceModifiers:
    ...
    def get_team_coefficient(self, team):
        ...
        # Integra posizione in classifica (ma non troppo)
        if team in CLASSIFICA_REALE_2025_26:
            pos = CLASSIFICA_REALE_2025_26[team]['pos']

            if pos <= 3:  # Top 3
                classifica_bonus = 1.15
            elif pos <= 6:  # Top 6
                classifica_bonus = 1.08
            elif pos <= 10:  # Media-alta
                classifica_bonus = 1.0
            elif pos <= 15:  # Media
                classifica_bonus = 0.93
            else:  # Bassa
                classifica_bonus = 0.85
        else:
    ...
    def get_team_performance_bonus(self, team, role):
        ...
        """
        if team not in CLASSIFICA_REALE_2025_26:
            return 1.0

        data = CLASSIFICA_REALE_2025_26[team]
        gf = data['gf']
        gs = data['gs']
