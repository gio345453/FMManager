...
from src.data.defense_modifier import calculate_defense_contribution_overall
    ...
    def calculate_weighted_stats(self):
        ...
        for _, player in current_players.iterrows():
            ...
            player_data = {
                ...
                'R': role_display,
                'FVM': pd.to_numeric(player.get('FVM', 0), errors='coerce'),
                ...
                for season_key, season_info in stats_data.items():
                    ...
                    if season_key in season_data:
                        ...
                        if col in player_row and pd.notna(player_row[col]):
                            ...
                            # Escludi valori zero: se un giocatore non ha mai giocato
                            # in una stagione, quella stagione non deve influenzare la media
                            if value != 0:
    ...
    def calculate_overall_scores(self, df):
        ...
        for idx, base_role in enumerate(base_roles_series):
            ...
            if total_weight > 0:
                ...
                # Applica bonus defense modifier per P e D
                defense_bonus = calculate_defense_contribution_overall(
                    {
                        'mv_weighted': temp_df.iloc[idx].get('Mv')
                    },
                    base_role
                )
                base_overall += defense_bonus
