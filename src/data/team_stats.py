...
class TeamStatsManager:
    ...
    def get_team_stats(self, team_name):
        ...
        elif team_players.empty:
            # Squadra non presente nella stagione corrente (potrebbe essere neopromossa nella prossima stagione)
            return {
                'squadra': team_name,
        ...
        for dept in ['P', 'D', 'C', 'A']:
            ...
            if dept_players.empty:
                ...
                departments[dept] = {
                    ...
                    'overall_media': round(fm_media, 2)  # Usa FM come proxy
                }
