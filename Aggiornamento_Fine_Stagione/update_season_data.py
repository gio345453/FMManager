...
class SeasonDataUpdater:
    ...
    def save_standings_dataset(self, standings):
        """Salva la classifica in un dataset JSON riusabile dai calcoli runtime."""
        output_path = Path('data/Calendario/season_standings.json')
        ...
        payload = {
            ...
            'teams': {
                team['nome']: {
                    ...
                    'gf': team['gol_fatti'],
                    'gs': team['gol_subiti'],
                    'partite': team['vittorie'] + team['pareggi'] + team['sconfitte'],
                }
                for team in standings
            },
        }
        ...
        print(f"💾 Classifica stagionale salvata: {output_path}")
    ...
    def run(self):
        ...
        if standings:
            self.save_standings_dataset(standings)
